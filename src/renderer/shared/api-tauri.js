...
(function () {
    ...
    window.api = {
        ...
        getVideos: () => invoke('get_videos').catch(() => []),
        deleteVideo: (id, withFile) => send('delete_video', { id, withFile: !!withFile }),
        openVideo: (id) => send('open_video', { id }),
        revealVideo: (id) => send('reveal_video', { id }),
        onUpdateVideos: (cb) => on('update-videos', cb),
