...
fn write_and_record(app: &tauri::AppHandle, text: &str) {
    if text.is_empty() {
        return;
    }
    {
...
#[tauri::command]
pub fn copy_item(app: tauri::AppHandle, text: String) {
...
#[tauri::command]
pub fn delete_history_item(app: tauri::AppHandle, id: String) {
...
#[tauri::command]
pub fn add_to_favorites(app: tauri::AppHandle, item: Value) {
    history::add_favorite(&app, &item);
}

#[tauri::command]
pub fn remove_from_favorites(app: tauri::AppHandle, id: String) {
    history::remove_favorite(&app, &id);
}

#[tauri::command]
pub fn set_item_note(app: tauri::AppHandle, id: String, note: String) {
    history::set_note(&app, &id, &note);
}

#[tauri::command]
pub fn reorder_history(app: tauri::AppHandle, history_items: Vec<Value>) {
    history::reorder(&app, "history", history_items);
}

#[tauri::command]
pub fn reorder_favorites(app: tauri::AppHandle, favorites: Vec<Value>) {
...
#[tauri::command]
pub fn set_max_items(app: tauri::AppHandle, count: i64) {
...
#[tauri::command]
pub fn set_quickpaste_count(app: tauri::AppHandle, count: i64) {
