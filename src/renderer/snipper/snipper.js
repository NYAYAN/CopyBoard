    ...
    if (state.selectionRect) {
        ...
        if (state.activeTool) {
            ...
            if (state.activeTool === 'text') {
                ...
                // oraya fırlıyordu. Yeni bir kutu için önce Tamam/Enter ile onayla
                // (ya da İptal/Escape ile kapat), sonra tıkla.
...
// Metni seçili renkte, seçim dikdörtgenine kırpılmış olarak çiz. Enter ve "Tamam"
// düğmesi AYNI yolu kullanıyor — mantık tek yerde.
function commitText() {
...
// Kutunun altındaki Tamam / İptal düğmeleri: kullanıcı Enter/Escape'i bilmese de
// görsel olarak onaylayıp iptal edebilsin. mousedown'da preventDefault — düğmeye
// basmak textarea'yı blur edip caret'i bozmasın ve overlay'in mousedown'ı
// (yeni seçim/çizim) tetiklenmesin.
